    ...
    return (<>
        <section id="concept">
            ...
            <div>
                ...
                <p>
                Alors si vous avez des projets incroyables ou des rêves fous, on va les réaliser ensemble avec "Nest Egg" ! Je vous montrerai comment planifier et atteindre tous nos objectifs financiers avec sagesse. <br/>
                <br/>
                Allez, rejoignez moi et embarquons dans cette aventure palpitante avec "Nest Egg" ! On va s'amuser, économiser et voler vers un avenir financier radieux !
                </p>
            </div>
